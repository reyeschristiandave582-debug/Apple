...
const AnnouncementBar = () => {
  ...
  return (
    <>
      ...
      {currentNotif && (
        <div
          className={`fixed top-[68px] left-3 right-3 sm:left-auto sm:right-4 z-[9999] max-w-md mx-auto sm:mx-0 flex items-center gap-2.5 rounded-xl border-l-[4px] border-[#10B981] bg-white/95 backdrop-blur-sm px-3 py-2 shadow-[0_8px_20px_rgba(0,0,0,0.12)] overflow-hidden transition-all duration-500 ease-in-out ${
            isVisible
